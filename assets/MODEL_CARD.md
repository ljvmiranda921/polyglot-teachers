...
| | |
|---|---|
| **Languages** | Arabic (ar), Czech (cs), German (de), Indonesian (id), Japanese (ja), Spanish (es), English (en) |
...
ds = load_dataset("ljvmiranda921/polyglot-teachers-sft", split="train")
