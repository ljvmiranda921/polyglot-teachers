...
# Polyglot-Gemma3-4B-SFT-{language}

This model is a fine-tuned version of [google/gemma-3-4b-pt](https://huggingface.co/google/gemma-3-4b-pt) on {language_name} synthetic data, using the best teacher-student combination identified in our paper [Polyglot Teachers: Evaluating Language Models for Multilingual Synthetic Data Generation]().
...
model_id = "ljvmiranda921/Polyglot-Gemma3-4B-SFT-{language}"
