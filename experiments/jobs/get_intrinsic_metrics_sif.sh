#!/bin/bash
# Job execution script for computing intrinsic metrics inside Singularity container
# This is the Singularity version of get_intrinsic_metrics.sh
...
# Note: No need to activate venv - dependencies are already in the container
...
OUTPUT_PATH="/app/metrics/msde-S1-${LANGUAGE}_${MODEL//\//__}_intrinsic_metrics.json"
